...
* Quantification is based on mapping the reads to the genomes using bbmap. Do you think the mapping rate is good? 

 what could be done to imprve it?
...
```{r ob2, echo=FALSE}
question("Which major change induced by the died do you observe at phylum level?",
...
```{r ob3, echo=FALSE}
question("What do you see atfamily level?",
  answer("- Muribaculaceae",correct=TRUE),
  answer("+ Lachnospiraceae",correct = TRUE),
  answer("- Lachnospiraceae"),
  answer("+ Lactobacillaceae",correct=TRUE),
  answer("+ Oscillospiraceae",correct = TRUE)
)
```
...
Even if the genome is uncultured, you can dig deeper in the taxonomy and look what other resercher have found out about this species. 
