...
In the first part of the tutorial you will learn how to install Atlas, init a new project and run it. Everithing is done in the command line. So **go to the terminal* in your jupyter or Rstudio interface, and make it bigger.
