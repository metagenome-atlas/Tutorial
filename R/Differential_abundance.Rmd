...
```{r plot_metadata, fig.width=1.5, fig.height=1.5}
...
grouping_columns= c("Sample",level,"Diet")
...
### PCA of the robust Aitchison distance
...
module_names= kegg_modules %>% select(c('module','module_name')) %>% distinct()
...
pheatmap(module_rel_ab, show_colnames = F, annotation_row =select(metadata,"Diet"))
