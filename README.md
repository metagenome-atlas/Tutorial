...
A real Metagenome-Atlas run can take more than a day. Therefore we have you prepared some output of a previous run the [`Example`](Example) folder.  The subdirectory `Results` contains the most interesting output of Atlas which is  summarized in this [report](http://htmlpreview.github.io/?https://github.com/metagenome-atlas/Tutorial/blob/master/Example/Results/Summary.html).
